...
void main() {
    ...
    float shadow = shadow_calculation_with_added_normal_bias(depth_proj.xyzw, var_world_normal, var_world_position);
   ...
   // resultColor += color.rgb * max(direct_light(sunlight_color, sun_position.xyz, var_world_position.xyz, var_world_normal, shadow_color), 0.0);

...
---@class OfflineIncomeScene:Scene
local Scene = BaseScene:subclass("OfflineIncomeScene")
function Scene:initialize()
	BaseScene.initialize(self, "OfflineIncomeScene", "/offline_income_scene#collectionproxy")

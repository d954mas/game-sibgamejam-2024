...
function EcsWorld:add_systems()
	...
	self.ecs:addSystem(SYSTEMS.PlayerGroundCheckSystem())
	self.ecs:addSystem(SYSTEMS.PlayerAutoJumpSystem())
	self.ecs:addSystem(SYSTEMS.BlockMoveSystem())
	self.ecs:addSystem(SYSTEMS.PlayerMoveSystem())
	self.ecs:addSystem(SYSTEMS.PlayerCheckCellSystem())

...
function Lights:initialize()
	illumination.lights_init(8, 8, 8, 8, 8)
...
function Lights:draw_shadow_debug()
	render.enable_texture("SHADOW_TEXTURE", self.shadow.rt or self.shadow.rt_no_shadow, render.BUFFER_COLOR_BIT)
...
function Lights:set_camera(x, y, z)
	...
	for idx, point in ipairs(POINTS_CUBE_RESULT) do
